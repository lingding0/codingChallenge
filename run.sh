...
### this is for Unit testbench run #####
#rm -f ./src/*.class
...
### this is for code submit run ###
rm -f ./src/*.class
javac -cp ".:/usr/share/java/junit-3.8.2.jar:../../lib/json-simple-1.1.1.jar" src/TweetHashtag.java src/Graph.java src/KeyOfTweetsComparator.java src/KeyOfTweets.java src/Node.java src/Tweet.java src/Tweets.java
java -cp ./src:../../lib/json-simple-1.1.1.jar TweetHashtag
